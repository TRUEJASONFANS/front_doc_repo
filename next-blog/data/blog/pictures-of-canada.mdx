...
Features images served using `next/image` component. The locally stored images are located in a folder with the following path: `/nextblog/static/images/canada/[filename].jpg`
...
<div className="flex flex-wrap -mx-2 overflow-hidden xl:-mx-2">
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image alt="Maple" src="/nextblog/static/images/canada/maple.jpg" width={640} height={427} />
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image alt="Lake" src="/nextblog/static/images/canada/lake.jpg" width={640} height={427} />
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image alt="Mountains" src="/nextblog/static/images/canada/mountains.jpg" width={640} height={427} />
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image alt="Toronto" src="/nextblog/static/images/canada/toronto.jpg" width={640} height={427} />
  </div>
</div>
