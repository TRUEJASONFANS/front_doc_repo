# react 试题
使用react 模拟一个交通信号灯 先长亮再闪烁， 颜色依次为红绿黄, 前3秒长亮后2秒闪烁。
```tsx
import React, { useEffect, useReducer, useState } from 'react';

const light_array = [ {color: 'red', duration:3000, splashDuration:2000}, {color:'green', duration:3000, splashDuration:2000}, {color:'yelllow', duration:3000, splashDuration:2000}]
