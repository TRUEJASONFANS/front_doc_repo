...
3. 区块，由组件组成，可以想象成代码片段。 你可以自己定义自己的[区块](https://umijs.org/zh/guide/block.html#%E4%BD%BF%E7%94%A8%E5%8C%BA%E5%9D%97)以达到快速的代码初始化。[
4. 页面模板，由区块组成
...
* MPA（多页应用）部署较为麻烦？
* 微前端 -> ["乾坤"](https://github.com/umijs/qiankun) 基于SPA 部署更简单？
